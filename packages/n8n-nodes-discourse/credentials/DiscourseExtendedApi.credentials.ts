...
export class DiscourseExtendedApi implements ICredentialType {
	name = 'discourseExtendedApi';

	// Keep explicit package qualifier to disambiguate from n8n's built-in Discourse credential in the UI.

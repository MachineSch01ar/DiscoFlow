...
export const description: INodeProperties[] = [
	{
		...
		default: '',
		displayOptions,
		description: 'Username whose sent mailbox to list. Defaults to API Username when empty.',
	},
	{
		displayName: 'Page',
		name: 'page',
...
export async function execute(
	...
	const response = await discourseApiRequest.call(
		...
		itemIndex,
		'GET',
		`/topics/private-messages-sent/${encodeURIComponent(mailboxUsername)}.json`,
		qs,
	);

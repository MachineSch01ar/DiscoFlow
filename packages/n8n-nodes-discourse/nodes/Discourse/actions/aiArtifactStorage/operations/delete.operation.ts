...
import { deleteArtifactKeyValue } from '../api';
...
export const description: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		displayOptions,
		description: 'Storage key to delete for the current user',
	},
];
...
export async function execute(
	...
	await deleteArtifactKeyValue.call(this, itemIndex, artifactId, key);
